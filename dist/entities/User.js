...
__decorate([
    ...
    typeorm_1.ManyToOne(() => Branch_1.Branch, (branch) => branch.users),
...
__decorate([
    ...
    typeorm_1.OneToMany(() => Purchase_1.Purchase, (purchase) => purchase.creator),
    __metadata("design:type", Array)
], User.prototype, "createdPurchases", void 0);
__decorate([
    type_graphql_1.Field(() => [Payment_1.Payment]),
    typeorm_1.OneToMany(() => Payment_1.Payment, (payment) => payment.creator),
    __metadata("design:type", Array)
], User.prototype, "createdPayments", void 0);
__decorate([
    type_graphql_1.Field(() => [Purchase_1.Purchase]),
    typeorm_1.OneToMany(() => Purchase_1.Purchase, (purchase) => purchase.supplier),
    __metadata("design:type", Array)
], User.prototype, "suppliedPurchases", void 0);
__decorate([
    type_graphql_1.Field(() => [ROR_1.ROR]),
    typeorm_1.OneToMany(() => ROR_1.ROR, (ROR) => ROR.creator),
    __metadata("design:type", Array)
], User.prototype, "RORS", void 0);
__decorate([
    type_graphql_1.Field(() => [Attendance_1.Attendance]),
    typeorm_1.OneToMany(() => Attendance_1.Attendance, (attendance) => attendance.creator),
    __metadata("design:type", Array)
], User.prototype, "createdAttendances", void 0);
__decorate([
    type_graphql_1.Field(() => [Attendance_1.Attendance]),
    typeorm_1.OneToMany(() => Attendance_1.Attendance, (attendance) => attendance.attendee),
    __metadata("design:type", Array)
], User.prototype, "attendances", void 0);
__decorate([
    type_graphql_1.Field(() => [Payment_1.Payment]),
    typeorm_1.OneToMany(() => Payment_1.Payment, (payment) => payment.payer),
    __metadata("design:type", Array)
], User.prototype, "payments", void 0);
__decorate([
    type_graphql_1.Field(() => [Payment_1.Payment]),
    typeorm_1.OneToMany(() => Payment_1.Payment, (payment) => payment.collector),
    __metadata("design:type", Array)
], User.prototype, "collections", void 0);
__decorate([
    type_graphql_1.Field(() => [IncentiveSheet_1.IncentiveSheet]),
    typeorm_1.ManyToMany(() => IncentiveSheet_1.IncentiveSheet, (IS) => IS.users),
    typeorm_1.JoinTable(),
    __metadata("design:type", Array)
...
__decorate([
    ...
    typeorm_1.OneToMany(() => Incentive_1.Incentive, (incentive) => incentive.staff),
    __metadata("design:type", Array)
], User.prototype, "incentives", void 0);
__decorate([
    type_graphql_1.Field(() => [Sale_1.Sale]),
    typeorm_1.OneToMany(() => Sale_1.Sale, (sale) => sale.client),
    __metadata("design:type", Array)
], User.prototype, "servedSales", void 0);
__decorate([
    type_graphql_1.Field(() => [Sale_1.Sale]),
    typeorm_1.OneToMany(() => Sale_1.Sale, (sale) => sale.creator),
    __metadata("design:type", Array)
], User.prototype, "createdSales", void 0);
__decorate([
    type_graphql_1.Field(() => [Expense_1.Expense]),
    typeorm_1.OneToMany(() => Expense_1.Expense, (xpense) => xpense.creator),
    __metadata("design:type", Array)
], User.prototype, "createdExpenses", void 0);
__decorate([
    type_graphql_1.Field(() => [Sale_1.Sale]),
    typeorm_1.OneToMany(() => Sale_1.Sale, (sale) => sale.seller),
    __metadata("design:type", Array)
], User.prototype, "initiatedSales", void 0);
__decorate([
    type_graphql_1.Field(() => [Expense_1.Expense]),
    typeorm_1.OneToMany(() => Expense_1.Expense, (expense) => expense.authorizer),
    __metadata("design:type", Array)
], User.prototype, "authorizedExpenses", void 0);
__decorate([
    type_graphql_1.Field(() => [Expense_1.Expense]),
    typeorm_1.OneToMany(() => Expense_1.Expense, (expense) => expense.staff),
    __metadata("design:type", Array)
], User.prototype, "receivedExpenses", void 0);
__decorate([
    type_graphql_1.Field(() => [Account_1.Account]),
    typeorm_1.OneToMany(() => Account_1.Account, (Account) => Account.creator),
    __metadata("design:type", Array)
], User.prototype, "createdAccounts", void 0);
__decorate([
    type_graphql_1.Field(() => [Asset_1.Asset]),
    typeorm_1.OneToMany(() => Asset_1.Asset, (Asset) => Asset.creator),
    __metadata("design:type", Array)
], User.prototype, "createdAssets", void 0);
__decorate([
    type_graphql_1.Field(() => [IncentiveSheet_1.IncentiveSheet]),
    typeorm_1.OneToMany(() => IncentiveSheet_1.IncentiveSheet, (IncentiveSheet) => IncentiveSheet.creator),
    __metadata("design:type", Array)
...
__decorate([
    typeorm_1.Column({ type: "text", default: "halisia" }),
    __metadata("design:type", String)
